$(function () {
    ...
    _0x47e03f = function (_0x4cf8de, _0x55263d) {
        var _0x4b01c4 = this.$tabs = $(_0x4cf8de),
            _0x24271e = this.options = $.extend(!![], {}, _0x125635, _0x55263d),
    ...
    _0x47e03f.prototype = {
        init: function () {
            ...
            if (this.$dropdown.length === 0x0) {
                this.flag = !![];
                this.$nav.append('<li class="dropdown" role="presentation">' + '<a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">' + '<span class="caret"></span> 更多</a><ul class="dropdown-menu" role="menu"></ul></li>');
        ...
        close: function() {
            ...
            this.$tabs.on('click', this.options.closeSelector, function (_0x188eb7) {
                ...
                var _0xdcc118 = $(_0x4fa0d5);
                if (_0x188eb7) {
                    _0x188eb7.preventDefault();
                }
                _0xdcc118.trigger(_0x188eb7 = $.Event('close.bs.tab'));
                ...
                $.support.transition && _0xdcc118.hasClass('fade') ? _0xdcc118.one('bsTransitionEnd', _0x53d66f).emulateTransitionEnd(0x96) : _0x53d66f();
            });
        }, 
    ...
    $.fn[_0x205a9a] = function (_0x2a639c) {
        if (typeof _0x2a639c === 'string') {
            ...
            if (/^_/.test(_0x2354fa)) {
                ...
                return this.each(function () {
                    var _0x438f38 = $.data(this, _0x205a9a);
            ...
            return this.each(function () {
                if (!$.data(this, _0x205a9a)) {
                    $.data(this, _0x205a9a, new _0x47e03f(this, _0x2a639c));
                } else {
                    $.data(this, _0x205a9a).init();
                }
            });
        }
    };
