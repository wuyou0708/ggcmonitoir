$(function () {
    ...
    $.site.menubar = {
        ...
        init: function () {
            var _0x55790f = this,
                _0x1a886f = this.$body = $('body'),
                _0x35ade1 = this.$html = $('html'),
                _0x3677c2 = this.$instance = $('#admui-navTabs');
            ...
            $('.nav-tabs li:not(.no-menu)').on('shown.bs.tab', function (_0x5c26c1) {
                var _0x59b3ed = _0x55790f.tabId = $(_0x5c26c1.target).attr('href');
                if (_0x1a886f.hasClass('site-menubar-fold')) {
        ...
        slimScroll: {
            ...
            destroy: function() {
                $.site.menubar.$instance.slimScroll({
                    'destroy': !![]
                });
        ...
        hoverscroll: {
            ...
            init: function (_0x3ae2e2) {
                $.site.menubar.$instance.find(_0x3ae2e2).children('div').attr('style', '');
                this.api = $.site.menubar.$instance.find(_0x3ae2e2).asHoverScroll({
