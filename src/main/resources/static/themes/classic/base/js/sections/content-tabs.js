    ...
    $.site.contentTabs = {
        ...
        bind: function() {
            ...
            _0xda9362.on('click.site.contabs', '.pull-right li.reload-page', function () {
                ...
                _0x283fcf.$content.children('[src="' + _0x3a8d20 + '"]').attr('src', _0x3a8d20);
                ...
                _0x25c2d9.each(function () {
                    ...
                    if (!_0x90ef18.is('.active') && _0x90ef18.index() !== 0x0) {
                        ...
                        _0x90ef18.remove();
                        _0x283fcf.$content.children('[name="' + _0x1e69bd + '"]').remove();
        ...
        ifameTabs: function(_0x36dbb8) {
            var _0x436e44 = this,
                _0x14ba97 = _0x36dbb8 === undefined ? document : _0x36dbb8;
            $(_0x14ba97).on('click', 'a[data-iframe]', function (_0x2bcac9) {
                var _0x4b994e = $(this),
                    _0x4c85e5, _0x16b7df = _0x4b994e.attr('href'),
                    _0x437b49 = $.trim(_0x4b994e.text()) || $.trim(_0x4b994e.attr('title')),
                ...
                if (_0x50c698 && _0xce1fc3 === '#admui-pageContent') {
                    //window.history.replaceState(null, '', '#!' + _0x16b7df);
                    _0x436e44.tabType = !![];
                    _0x436e44.buildTab({
                        'name': _0x437b49,
                        'url': _0x16b7df
                    ...
                    $(_0xce1fc3).find('iframe.active').attr('src', _0x16b7df);
                }
        ...
        _checkoutTab: function(_0xa46665) {
            var _0x218acf = this.$content,
                ...
                _0x35074f = _0x218acf.children('iframe[name="' + _0x110ed0 + '"]');
        ...
        enable: function(_0x37d964) {
            var _0x5dae98 = this.$instance,
                ...
                _0x5b203c = _0x5dae98.find('a[href="' + _0x15921d + '"]'),
            ...
            if (_0x3e048c !== _0x5f3fe8) {
                $('#admui-navbar a[href="#' + _0x5f3fe8 + '"]').tab('show');
            }
        ...
        buildTab: function(_0x49e9db) {
            ...
            _0x39c4aa.append('<li  class="active"><a href="' + _0x39dfa2 + '" target="' + _0x3cd4a4 + '" title="' + _0x49e9db.name + '' + '" rel="contents"><span>' + _0x49e9db.name + '</span><i class="icon' + ' wb-close-mini">' + '</i></a></li>');
            _0x4d6a1e[_0x3cd4a4] = {
                'url': _0x39dfa2,
                'name': _0x49e9db.name
            };
        ...
        buildIframe: function(_0x2d0f5e) {
            ...
            _0x24803f = _0xb8312e.find('iframe[name="' + _0x1c124a + '"]');
        ...
        closeTab: function(_0x1be84c) {
            ...
            _0x1be84c.remove();
            _0x5918d4.children('[name="' + _0x192b6c + '"]').remove();
